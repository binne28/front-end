...
function ListTraxanh({ isLogin }) {
  const listTraxanh = [
    {
      url: 'https://minio.thecoffeehouse.com/image/admin/1737355604_tx-latte-nong_400x400.png',
      name_cf: 'Trà Xanh Latte',
      price: '55.000đ',
    },
    {
      url: 'https://minio.thecoffeehouse.com/image/admin/1737355604_tx-latte-nong_400x400.png',
            ...
            <div className='product_card'>
              ...
              <div className='content_product'>
                ...
                <div className='content_top'>
                  <h4 className='text-[#353d45] text-[18px]'>{tx.name_cf}</h4>
                </div>
                {/* price */}
                <div className={`product_content_footer flex items-center px-2 ${isLogin ? 'justify-between' : 'justify-center'}`}>
                  <p className='my-auto font-medium text-[20px]'>{tx.price}</p>
                  {isLogin && (
                    <button
